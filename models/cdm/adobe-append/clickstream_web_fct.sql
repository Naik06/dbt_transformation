...
-- create table `ncau-data-newsquery-dev.cdm_adobe.clickstream_web_fct` 
...
(SELECT 
  'ADOBE WEB' AS SourceCode, post_visid_high, post_visid_low, visit_num, visit_page_num, post_prop2, post_prop3, post_prop4, post_prop5
  , post_prop6, post_prop9, page_url, post_prop12, post_prop14, post_prop15, event_list, COALESCE(post_prop17, post_evar82) AS post_prop17
...
-----------------------
  FROM {{ source ('sdm_adobe_web','clickstream_ingest') }} A1
    WHERE
     ...
     ------LIKE '%article%' or ifnull(post_prop9,'Unspecified') like '%blogs%' or ifnull(post_prop9,'Unspecified') LIKE '%gallery%' )
      ...
      and exclude_hit = 0
        --and post_page_event=0  ----
          and DatePartitioned between DATE_SUB( "2021-11-01" ,INTERVAL 1 DAY) and "2021-11-30"   ----DATE_SUB('2021-11-01',INTERVAL 1 DAY) and '2021-11-30' -----'2021-11-01' and '2021-11-30' -----
